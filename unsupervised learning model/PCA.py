...
x_pc1 = projection_pc2 * components[0][0]
y_pc1 = projection_pc2 * components[0][1]
...
plt.title('Linear Correlation Data Projection')
plt.xlabel('X1')
plt.ylabel('X2')
plt.legend()
plt.grid(True)
...
for color, i, target_name in zip(colors, [0, 1, 2], target_names):
    plt.scatter(X_pca[y == i, 0], X_pca[y == i, 1], color=color, s=50, ec='k', alpha=.8, lw=lw, label=target_name)
