...
# Example threshold to add outliers for larger feature values
threshold = 1.5
...
# Scatter plots of the original data with outliers
...
# Create a high-dimensional synthetic dataset with a small number of informative using make_regression
...
# Initialize and fit thew linear regression models and use them to predict the target
...
# Choose a threshold value to select features based on the Lasso model coefficient
