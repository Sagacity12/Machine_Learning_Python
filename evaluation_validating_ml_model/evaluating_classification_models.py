...
# Display the first few rows of the standarized original and noisy data set
print("Original Data (First 5 row):" )
df.head()

print("\nNoisy Data (First 5 row):")
df_noisy.head()
...
# plotting the two features together to get sense of their differences
plt.figure(figsize=(12, 6))
...
# Comparing the two features using a scatterplot
plt.figure(figsize=(12, 6))
