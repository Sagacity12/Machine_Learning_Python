...
def evaluate_clustering(X, labels, n_clusters, ax=None, suffix=''):
    ...
    ax.set_title(f'Silhouette Score for {suffix} \n' +
...
plt.subplot(1, 3, 3)
evaluate_clustering(X, y_kmeans, n_clusters, suffix=' k-Means Clustering')
plt.show()
...
plt.subplot(1, 3, 3)
plt.plot(inertia_values, davies_bouldin_score, marker='o')
...
evaluate_clustering(X, y_true, n_clusters=3, ax=axes[1, 0], suffix=' True Labels')
